...
export const metadata: Metadata = {
  ...
  description:
    "Individualised clinical nutrition and feeding support for patients with specialised nutritional requirements, including tube-feeding needs.",
};
  ...
  return (
    <StructuredProgramme
      intro={{
        ...
        title: "Clinical Nutrition & Tube-Feed Support.",
        body: "Individualised clinical nutrition and feeding support for patients with specialised nutritional requirements, including tube-feeding needs. Healthecy helps coordinate this support alongside the treating medical team.",
      }}
      ...
      ctaLabel="Discuss Tube-Feed Support"
    />
  );
}
