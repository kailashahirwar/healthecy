...
export const metadata: Metadata = {
  ...
  description:
    "Clinical nutrition and lifestyle support for people managing digestive and gastrointestinal health needs, alongside appropriate medical guidance.",
};
...
export default function DigestiveGutCarePage() {
  return (
    <StructuredProgramme
      ...
      ctaLabel="Discuss Digestive & Gut Health Support"
    />
  );
}
