...
export const metadata: Metadata = {
  ...
  description:
    "Physiotherapy-led rehabilitation and movement support for musculoskeletal conditions, post-operative recovery, joint replacement and other physical health needs.",
};
...
export default function PhysiotherapyRehabilitationPage() {
  return (
    <>
      <PageIntro
        eyebrow="Physical rehabilitation"
        title="Physical Rehabilitation & Musculoskeletal Care."
