...
export const metadata: Metadata = {
  ...
  description:
    "Supportive care focused on nutrition, rehabilitation, physical function and overall well-being during or after cancer treatment.",
};
  ...
  return (
    <StructuredProgramme
      intro={{
        ...
        title: "Onco-Recovery & Support.",
        body: "Supportive care focused on nutrition, rehabilitation, physical function and overall well-being during or after cancer treatment. Healthecy coordinates this support alongside your oncologist’s treatment plan.",
      }}
      approachTitle="Protecting nutrition, function and quality of life."
      approachBody="The Onco-Recovery & Support programme is designed to help patients and families navigate the practical recovery needs that can arise during and after treatment. Your treating oncologist remains central to medical decisions; Healthecy helps coordinate complementary support around the wider journey."
      pillars={[
