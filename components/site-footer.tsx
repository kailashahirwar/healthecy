    ...
    <footer className="mt-auto bg-primary text-primary-foreground">
      <div className="mx-auto max-w-7xl px-5 py-14 lg:px-8 lg:py-16">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-[1.3fr_0.8fr_0.8fr_1fr]">
          <div>
            <Link href="/" className="inline-flex items-center" aria-label="Healthecy home">
              <img
                src="/images/logo.png"
                alt="Healthecy"
                className="block h-12 w-auto max-w-[240px] object-contain object-left"
              />
            </Link>
